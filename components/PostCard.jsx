...
const PostCard = ({ post }) => {
    console.log(post)
    return (
        <div className="post-card shadow-lg rounded-lg p-8 lg:p-8 pb-12 mb-5 lg:mb-1 lg:col-span-12 lg:p-10 md:p-10">
            ...
            <h1 className="transition duration-200 text-left mb-3 cursor-pointer">
